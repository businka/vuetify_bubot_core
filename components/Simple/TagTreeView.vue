<script>
// import buxios from 'bubot-helper/buxios'
...
const { objHasOwnProperty } = require('bubot-helper/BaseHelper')
const { findIndexInArrayObj } = require('bubot-helper/ArrayHelper')
